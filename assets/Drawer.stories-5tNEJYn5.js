import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{Jn as n,Lr as r,Mr as i,Ua as a,Un as o,Vi as s,Zt as c,an as l,at as u,c as d,cn as f,dn as p,en as m,l as h,m as g,s as _}from"./iframe-BSRkYts9.js";var v,y=e((()=>{g(),_(),v=e=>d(o,{...e});try{v.displayName=`Drawer`,v.__docgenInfo={description:``,displayName:`Drawer`,filePath:`/home/runner/work/design-system/design-system/src/components/Navigation/Drawer/stories/Drawer.tsx`,methods:[],props:{component:{defaultValue:null,declarations:[{fileName:`design-system/node_modules/@mui/material/esm/Modal/Modal.d.ts`,name:`TypeLiteral`}],description:``,name:`component`,required:!1,tags:{},type:{name:`ElementType<any, keyof IntrinsicElements>`}},slots:{defaultValue:{value:`{}`},declarations:[{fileName:`design-system/node_modules/@mui/material/esm/utils/types.d.ts`,name:`TypeLiteral`}],description:`The components used for each slot inside.`,name:`slots`,required:!1,tags:{default:`{}`},type:{name:`Partial<DrawerSlots>`}},slotProps:{defaultValue:{value:`{}`},declarations:[{fileName:`design-system/node_modules/@mui/material/esm/utils/types.d.ts`,name:`TypeLiteral`}],description:`The props used for each slot inside.`,name:`slotProps`,required:!1,tags:{default:`{}`},type:{name:`{ root?: SlotProps<ElementType<ModalProps, keyof IntrinsicElements>, DrawerRootSlotPropsOverrides, DrawerOwnerState>; backdrop?: SlotProps<...>; docked?: SlotProps<...> | undefined; paper?: SlotProps<...> | undefined; transition?: SlotProps<...> | undefined; } | undefined`}}},tags:{}}}catch{}})),b,x,S,C,w;e((()=>{g(),b=t(a(),1),y(),_(),x=e=>{let[t,a]=(0,b.useState)({bottom:!1,left:!1,right:!1,top:!1}),o=d(s,{className:`MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-vubbuv`,focusable:`false`,"aria-hidden":`true`,viewBox:`0 0 24 24`,"data-testid":`FavoriteIcon`,children:d(`path`,{d:`m12 21.35-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z`})}),g=(e,n)=>r=>{r.type===`keydown`&&(r.key===`Tab`||r.key===`Shift`)||a({...t,[e]:n})},_=e=>h(r,{sx:{width:e===`top`||e===`bottom`?`auto`:250},role:`presentation`,onClick:g(e,!1),onKeyDown:g(e,!1),children:[d(p,{children:[`Inbox`,`Starred`,`Send email`,`Drafts`].map(e=>d(l,{disablePadding:!0,children:h(f,{children:[d(m,{children:o}),d(c,{primary:e})]})},e))}),d(n,{}),d(p,{children:[`All mail`,`Trash`,`Spam`].map(e=>d(l,{disablePadding:!0,children:h(f,{children:[d(m,{children:o}),d(c,{primary:e})]})},e))})]});return d(u,{direction:`row`,spacing:1,display:`flex`,alignItems:`center`,justifyContent:`center`,height:`100%`,children:[`left`,`right`,`top`,`bottom`].map(n=>h(b.Fragment,{children:[d(i,{onClick:g(n,!0),variant:`outlined`,children:n}),d(v,{anchor:n,open:t[n],onClose:g(n,!1),...e,children:_(n)})]},n))})},S=x.bind({}),S.args={},C={component:v,title:`Components/Navigation/Drawer`},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`args => {
